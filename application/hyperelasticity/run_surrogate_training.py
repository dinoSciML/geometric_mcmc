...
if __name__=="__main__":
    ...
    parser.add_argument('--n_train', type=int, default=4096, help='Number of training samples')
    parser.add_argument('--n_validation', type=int, default=128, help='Number of validation samples')
    parser.add_argument('--n_test', type=int, default=768, help='Number of testing samples')
