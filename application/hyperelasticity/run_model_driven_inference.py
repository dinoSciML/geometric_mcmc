...
if __name__ == "__main__":
    ...
    settings["step_size_tuning"]["step_size_max"] = 4       # The maximum step size for tuning. Used when tune_step_size is 1
    settings["step_size_tuning"]["step_size_min"] = 0.1     # The minimum step size for tuning. Used when tune_step_size is 1
    settings["step_size_tuning"]["n_samples"] = 2000 # The number of samples for tuning the step size
    settings["step_size_tuning"]["n_burn_in"] = 500 # The burn-in period for tuning the step size
